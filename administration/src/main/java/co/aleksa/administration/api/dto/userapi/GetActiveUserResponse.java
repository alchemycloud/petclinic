...
public class GetActiveUserResponse implements Serializable {
    ...
    public final GetActiveUserResponse setId(UserId id) {
        this.id = id;
        return this;
    }
    ...
    public final GetActiveUserResponse setFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public final GetActiveUserResponse setLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public final GetActiveUserResponse setBirthday(ZonedDateTime birthday) {
        this.birthday = birthday;
        return this;
    }
    ...
    public final GetActiveUserResponse setActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public final GetActiveUserResponse setRole(UserRole role) {
        this.role = role;
        return this;
    }
    ...
    public final GetActiveUserResponse setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public final GetActiveUserResponse setPasswordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }
    ...
    public final GetActiveUserResponse setEmailVerificationCode(String emailVerificationCode) {
        this.emailVerificationCode = emailVerificationCode;
        return this;
    }
    ...
    public final GetActiveUserResponse setEmailVerificationCodeTimestamp(ZonedDateTime emailVerificationCodeTimestamp) {
        this.emailVerificationCodeTimestamp = emailVerificationCodeTimestamp;
        return this;
    }
    ...
    public final GetActiveUserResponse setEmailVerified(Boolean emailVerified) {
        this.emailVerified = emailVerified;
        return this;
    }
    ...
    public final GetActiveUserResponse setResetPasswordCode(String resetPasswordCode) {
        this.resetPasswordCode = resetPasswordCode;
        return this;
    }
    ...
    public final GetActiveUserResponse setResetPasswordCodeTimestamp(ZonedDateTime resetPasswordCodeTimestamp) {
        this.resetPasswordCodeTimestamp = resetPasswordCodeTimestamp;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (GetActiveUserResponse.class != obj.getClass()) {
            return false;
        }
