...
public class SignUpRequest implements Serializable {
    ...
    public SignUpRequest(String firstName, String lastName, ZonedDateTime birthday, Boolean active, String email, String password) {
        this();
    ...
    public final SignUpRequest setBirthday(ZonedDateTime birthday) {
        this.birthday = birthday;
        return this;
    }
