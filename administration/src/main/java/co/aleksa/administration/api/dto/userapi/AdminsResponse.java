...
public class AdminsResponse implements Serializable {
    ...
    public final AdminsResponse setId(UserId id) {
        this.id = id;
        return this;
    }
    ...
    public final AdminsResponse setFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public final AdminsResponse setLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public final AdminsResponse setBirthday(ZonedDateTime birthday) {
        this.birthday = birthday;
        return this;
    }
    ...
    public final AdminsResponse setActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public final AdminsResponse setRole(UserRole role) {
        this.role = role;
        return this;
    }
    ...
    public final AdminsResponse setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public final AdminsResponse setPasswordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }
    ...
    public final AdminsResponse setEmailVerificationCode(String emailVerificationCode) {
        this.emailVerificationCode = emailVerificationCode;
        return this;
    }
    ...
    public final AdminsResponse setEmailVerificationCodeTimestamp(ZonedDateTime emailVerificationCodeTimestamp) {
        this.emailVerificationCodeTimestamp = emailVerificationCodeTimestamp;
        return this;
    }
    ...
    public final AdminsResponse setEmailVerified(Boolean emailVerified) {
        this.emailVerified = emailVerified;
        return this;
    }
    ...
    public final AdminsResponse setResetPasswordCode(String resetPasswordCode) {
        this.resetPasswordCode = resetPasswordCode;
        return this;
    }
    ...
    public final AdminsResponse setResetPasswordCodeTimestamp(ZonedDateTime resetPasswordCodeTimestamp) {
        this.resetPasswordCodeTimestamp = resetPasswordCodeTimestamp;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AdminsResponse.class != obj.getClass()) {
            return false;
        }
