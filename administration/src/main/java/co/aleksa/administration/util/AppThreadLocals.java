...
import co.aleksa.administration.audit.AuditContext;
...
public final class AppThreadLocals {
    ...
    private static final ThreadLocal<Optional<String>> TENANT = ThreadLocal.withInitial(Optional::empty);
    ...
    public static void initialize(Optional<String> correlationId, Optional<String> tenant, Optional<String> principalEmail) {
        clear();
    ...
    public static void setTenant(Optional<String> tenant) {
        TENANT.set(tenant);
        tenant.ifPresent(MDCUtil::putTenant);
    }
