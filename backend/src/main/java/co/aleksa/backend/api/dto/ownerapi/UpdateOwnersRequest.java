...
public class UpdateOwnersRequest implements Serializable {
    ...
    private UpdateOwnersRequest() {}

    public UpdateOwnersRequest(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final UpdateOwnersRequest setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateOwnersRequest setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UpdateOwnersRequest setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final UpdateOwnersRequest setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final UpdateOwnersRequest setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateOwnersRequest.class != obj.getClass()) {
            return false;
        }
