...
public class CreateVetResponse implements Serializable {
    ...
    private CreateVetResponse() {}

    public CreateVetResponse(VetId id, UserId userId, FileDTO image) {
        this();
        this.id = id;
        this.userId = userId;
        this.image = image;
    ...
    public final CreateVetResponse setId(VetId id) {
        this.id = id;
        return this;
    }
    ...
    public final CreateVetResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final CreateVetResponse setImage(FileDTO image) {
        this.image = image;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (CreateVetResponse.class != obj.getClass()) {
            return false;
        }
    ...
    public String toString() {
        return "CreateVetResponse[" + "this.id=" + this.id + ", this.userId=" + this.userId + ", this.image=" + this.image + "]";
    }
}
