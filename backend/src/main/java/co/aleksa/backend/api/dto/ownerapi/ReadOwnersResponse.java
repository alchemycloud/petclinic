...
public class ReadOwnersResponse implements Serializable {
    ...
    private ReadOwnersResponse() {}

    public ReadOwnersResponse(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final ReadOwnersResponse setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final ReadOwnersResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final ReadOwnersResponse setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final ReadOwnersResponse setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final ReadOwnersResponse setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (ReadOwnersResponse.class != obj.getClass()) {
            return false;
        }
