...
public class UpdateOwnersResponse implements Serializable {
    ...
    private UpdateOwnersResponse() {}

    public UpdateOwnersResponse(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final UpdateOwnersResponse setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateOwnersResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UpdateOwnersResponse setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final UpdateOwnersResponse setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final UpdateOwnersResponse setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateOwnersResponse.class != obj.getClass()) {
            return false;
        }
