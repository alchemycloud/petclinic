...
public class CreatePetResponse implements Serializable {
    ...
    public CreatePetResponse(PetId id, OwnerId ownerId, String name, ZonedDateTime birthday, PetType petType, Boolean vaccinated) {
        this();
        this.id = id;
    ...
    public final CreatePetResponse setBirthday(ZonedDateTime birthday) {
        this.birthday = birthday;
        return this;
    }
