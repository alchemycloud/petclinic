...
public class UpdatePetRequest implements Serializable {
    ...
    public UpdatePetRequest(PetId id, OwnerId ownerId, String name, ZonedDateTime birthday, PetType petType, Boolean vaccinated) {
        this();
        this.id = id;
    ...
    public final UpdatePetRequest setBirthday(ZonedDateTime birthday) {
        this.birthday = birthday;
        return this;
    }
