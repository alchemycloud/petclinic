...
public class UpdatePetResponse implements Serializable {
    ...
    public UpdatePetResponse(PetId id, OwnerId ownerId, String name, ZonedDateTime birthday, PetType petType, Boolean vaccinated) {
        this();
        this.id = id;
    ...
    public final UpdatePetResponse setBirthday(ZonedDateTime birthday) {
        this.birthday = birthday;
        return this;
    }
