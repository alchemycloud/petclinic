...
public class RestCreateVetRequest implements Serializable {
    ...
    public RestCreateVetRequest(UserId userId, FileUploadDTO image, UserId userId) {
        this();
        this.userId = userId;
        this.image = image;
        this.userId = userId;
    ...
    public String toString() {
        return "RestCreateVetRequest[" + "this.userId=" + this.userId + ", this.image=" + this.image + ", this.userId=" + this.userId + "]";
    }
}
