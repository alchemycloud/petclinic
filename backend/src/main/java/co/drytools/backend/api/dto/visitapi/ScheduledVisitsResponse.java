...
public class ScheduledVisitsResponse implements Serializable {
    ...
    private ScheduledVisitsResponse() {}

    public ScheduledVisitsResponse(
    ...
    public final ScheduledVisitsResponse setId(VisitId id) {
        this.id = id;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setVetId(VetId vetId) {
        this.vetId = vetId;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setPetId(PetId petId) {
        this.petId = petId;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setVisitNumber(Integer visitNumber) {
        this.visitNumber = visitNumber;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setTimestamp(ZonedDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setPetWeight(BigDecimal petWeight) {
        this.petWeight = petWeight;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public final ScheduledVisitsResponse setScheduled(Boolean scheduled) {
        this.scheduled = scheduled;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (ScheduledVisitsResponse.class != obj.getClass()) {
            return false;
        }
    ...
    public String toString() {
        return "ScheduledVisitsResponse["
                + "this.id="
                + this.id
                + ", this.vetId="
                + this.vetId
