...
public class AdminUsersResponse implements Serializable {
    ...
    public final AdminUsersResponse setId(UserId id) {
        this.id = id;
        return this;
    }
    ...
    public final AdminUsersResponse setFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public final AdminUsersResponse setLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public final AdminUsersResponse setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public final AdminUsersResponse setActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public final AdminUsersResponse setRole(UserRole role) {
        this.role = role;
        return this;
    }
    ...
    public final AdminUsersResponse setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public final AdminUsersResponse setPasswordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }
    ...
    public final AdminUsersResponse setEmailVerificationCode(String emailVerificationCode) {
        this.emailVerificationCode = emailVerificationCode;
        return this;
    }
    ...
    public final AdminUsersResponse setEmailVerificationCodeTimestamp(ZonedDateTime emailVerificationCodeTimestamp) {
        this.emailVerificationCodeTimestamp = emailVerificationCodeTimestamp;
        return this;
    }
    ...
    public final AdminUsersResponse setEmailVerified(Boolean emailVerified) {
        this.emailVerified = emailVerified;
        return this;
    }
    ...
    public final AdminUsersResponse setResetPasswordCode(String resetPasswordCode) {
        this.resetPasswordCode = resetPasswordCode;
        return this;
    }
    ...
    public final AdminUsersResponse setResetPasswordCodeTimestamp(ZonedDateTime resetPasswordCodeTimestamp) {
        this.resetPasswordCodeTimestamp = resetPasswordCodeTimestamp;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AdminUsersResponse.class != obj.getClass()) {
            return false;
        }
