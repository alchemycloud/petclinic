...
public class UpdatePetResponse implements Serializable {
    ...
    public UpdatePetResponse(PetId id, OwnerId ownerId, String name, ZonedDateTime birthdate, PetType petType, Boolean vaccinated) {
        this();
        this.id = id;
    ...
    public final UpdatePetResponse setId(PetId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdatePetResponse setOwnerId(OwnerId ownerId) {
        this.ownerId = ownerId;
        return this;
    }
    ...
    public final UpdatePetResponse setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public final UpdatePetResponse setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public final UpdatePetResponse setPetType(PetType petType) {
        this.petType = petType;
        return this;
    }
    ...
    public final UpdatePetResponse setVaccinated(Boolean vaccinated) {
        this.vaccinated = vaccinated;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdatePetResponse.class != obj.getClass()) {
            return false;
        }
