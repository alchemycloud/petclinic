...
public class CreateOwnerRequest implements Serializable {
    ...
    private CreateOwnerRequest() {}

    public CreateOwnerRequest(UserId userId, String address, String city, String telephone) {
        this();
        this.userId = userId;
    ...
    public final CreateOwnerRequest setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final CreateOwnerRequest setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final CreateOwnerRequest setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final CreateOwnerRequest setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (CreateOwnerRequest.class != obj.getClass()) {
            return false;
        }
