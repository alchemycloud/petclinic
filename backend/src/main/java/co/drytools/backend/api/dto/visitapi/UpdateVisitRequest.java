...
public class UpdateVisitRequest implements Serializable {
    ...
    public final UpdateVisitRequest setId(VisitId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateVisitRequest setVetId(VetId vetId) {
        this.vetId = vetId;
        return this;
    }
    ...
    public final UpdateVisitRequest setPetId(PetId petId) {
        this.petId = petId;
        return this;
    }
    ...
    public final UpdateVisitRequest setVisitNumber(Integer visitNumber) {
        this.visitNumber = visitNumber;
        return this;
    }
    ...
    public final UpdateVisitRequest setTimestamp(ZonedDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public final UpdateVisitRequest setPetWeight(BigDecimal petWeight) {
        this.petWeight = petWeight;
        return this;
    }
    ...
    public final UpdateVisitRequest setDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public final UpdateVisitRequest setScheduled(Boolean scheduled) {
        this.scheduled = scheduled;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateVisitRequest.class != obj.getClass()) {
            return false;
        }
