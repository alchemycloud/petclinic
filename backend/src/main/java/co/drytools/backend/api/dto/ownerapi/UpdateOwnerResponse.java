...
public class UpdateOwnerResponse implements Serializable {
    ...
    private UpdateOwnerResponse() {}

    public UpdateOwnerResponse(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final UpdateOwnerResponse setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateOwnerResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UpdateOwnerResponse setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final UpdateOwnerResponse setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final UpdateOwnerResponse setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateOwnerResponse.class != obj.getClass()) {
            return false;
        }
