...
public class ReadVisitResponse implements Serializable {
    ...
    private ReadVisitResponse() {}

    public ReadVisitResponse(
    ...
    public final ReadVisitResponse setId(VisitId id) {
        this.id = id;
        return this;
    }
    ...
    public final ReadVisitResponse setVetId(VetId vetId) {
        this.vetId = vetId;
        return this;
    }
    ...
    public final ReadVisitResponse setPetId(PetId petId) {
        this.petId = petId;
        return this;
    }
    ...
    public final ReadVisitResponse setVisitNumber(Integer visitNumber) {
        this.visitNumber = visitNumber;
        return this;
    }
    ...
    public final ReadVisitResponse setTimestamp(ZonedDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public final ReadVisitResponse setPetWeight(BigDecimal petWeight) {
        this.petWeight = petWeight;
        return this;
    }
    ...
    public final ReadVisitResponse setDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public final ReadVisitResponse setScheduled(Boolean scheduled) {
        this.scheduled = scheduled;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (ReadVisitResponse.class != obj.getClass()) {
            return false;
        }
