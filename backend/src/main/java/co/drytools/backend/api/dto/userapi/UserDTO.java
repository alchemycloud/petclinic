...
public class UserDTO implements Serializable {
    ...
    public UserDTO(UserId id, String email, String firstName, String lastName, ZonedDateTime birthdate, Boolean active) {
        this();
        this.id = id;
        this.email = email;
    ...
    public final UserDTO setId(UserId id) {
        this.id = id;
        return this;
    }
    ...
    public final UserDTO setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public final UserDTO setActive(Boolean active) {
        this.active = active;
        return this;
    }
