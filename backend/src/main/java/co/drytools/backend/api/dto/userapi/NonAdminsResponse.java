...
public class NonAdminsResponse implements Serializable {
    ...
    private NonAdminsResponse() {}

    public NonAdminsResponse(
            UserId id,
            String firstName,
            String lastName,
    ...
    public final NonAdminsResponse setId(UserId id) {
        this.id = id;
        return this;
    }
    ...
    public final NonAdminsResponse setFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public final NonAdminsResponse setLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public final NonAdminsResponse setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public final NonAdminsResponse setActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public final NonAdminsResponse setRole(UserRole role) {
        this.role = role;
        return this;
    }
    ...
    public final NonAdminsResponse setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public final NonAdminsResponse setPasswordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }
    ...
    public final NonAdminsResponse setEmailVerificationCode(String emailVerificationCode) {
        this.emailVerificationCode = emailVerificationCode;
        return this;
    }
    ...
    public final NonAdminsResponse setEmailVerificationCodeTimestamp(ZonedDateTime emailVerificationCodeTimestamp) {
        this.emailVerificationCodeTimestamp = emailVerificationCodeTimestamp;
        return this;
    }
    ...
    public final NonAdminsResponse setEmailVerified(Boolean emailVerified) {
        this.emailVerified = emailVerified;
        return this;
    }
    ...
    public final NonAdminsResponse setResetPasswordCode(String resetPasswordCode) {
        this.resetPasswordCode = resetPasswordCode;
        return this;
    }
    ...
    public final NonAdminsResponse setResetPasswordCodeTimestamp(ZonedDateTime resetPasswordCodeTimestamp) {
        this.resetPasswordCodeTimestamp = resetPasswordCodeTimestamp;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (NonAdminsResponse.class != obj.getClass()) {
            return false;
        }
