...
public class AllOwnersResponse implements Serializable {
    ...
    private AllOwnersResponse() {}

    public AllOwnersResponse(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final AllOwnersResponse setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final AllOwnersResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final AllOwnersResponse setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final AllOwnersResponse setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final AllOwnersResponse setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AllOwnersResponse.class != obj.getClass()) {
            return false;
        }
