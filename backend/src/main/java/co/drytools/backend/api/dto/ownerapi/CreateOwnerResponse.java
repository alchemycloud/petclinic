...
public class CreateOwnerResponse implements Serializable {
    ...
    public CreateOwnerResponse(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final CreateOwnerResponse setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final CreateOwnerResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final CreateOwnerResponse setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final CreateOwnerResponse setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final CreateOwnerResponse setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (CreateOwnerResponse.class != obj.getClass()) {
            return false;
        }
