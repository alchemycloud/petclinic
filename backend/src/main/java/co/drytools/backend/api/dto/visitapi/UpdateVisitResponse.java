...
public class UpdateVisitResponse implements Serializable {
    ...
    public final UpdateVisitResponse setId(VisitId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateVisitResponse setVetId(VetId vetId) {
        this.vetId = vetId;
        return this;
    }
    ...
    public final UpdateVisitResponse setPetId(PetId petId) {
        this.petId = petId;
        return this;
    }
    ...
    public final UpdateVisitResponse setVisitNumber(Integer visitNumber) {
        this.visitNumber = visitNumber;
        return this;
    }
    ...
    public final UpdateVisitResponse setTimestamp(ZonedDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public final UpdateVisitResponse setPetWeight(BigDecimal petWeight) {
        this.petWeight = petWeight;
        return this;
    }
    ...
    public final UpdateVisitResponse setDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public final UpdateVisitResponse setScheduled(Boolean scheduled) {
        this.scheduled = scheduled;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateVisitResponse.class != obj.getClass()) {
            return false;
        }
