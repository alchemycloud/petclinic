...
public class UpdatePetRequest implements Serializable {
    ...
    public UpdatePetRequest(PetId id, OwnerId ownerId, String name, ZonedDateTime birthdate, PetType petType, Boolean vaccinated) {
        this();
        this.id = id;
    ...
    public final UpdatePetRequest setId(PetId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdatePetRequest setOwnerId(OwnerId ownerId) {
        this.ownerId = ownerId;
        return this;
    }
    ...
    public final UpdatePetRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public final UpdatePetRequest setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public final UpdatePetRequest setPetType(PetType petType) {
        this.petType = petType;
        return this;
    }
    ...
    public final UpdatePetRequest setVaccinated(Boolean vaccinated) {
        this.vaccinated = vaccinated;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdatePetRequest.class != obj.getClass()) {
            return false;
        }
