...
public class ReadPetResponse implements Serializable {
    ...
    public ReadPetResponse(PetId id, OwnerId ownerId, String name, ZonedDateTime birthdate, PetType petType, Boolean vaccinated) {
        this();
        this.id = id;
    ...
    public final ReadPetResponse setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
