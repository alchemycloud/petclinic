...
public class UpdateOwnerRequest implements Serializable {
    ...
    public UpdateOwnerRequest(OwnerId id, UserId userId, String address, String city, String telephone) {
        this();
        this.id = id;
        this.userId = userId;
    ...
    public final UpdateOwnerRequest setId(OwnerId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateOwnerRequest setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UpdateOwnerRequest setAddress(String address) {
        this.address = address;
        return this;
    }
    ...
    public final UpdateOwnerRequest setCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public final UpdateOwnerRequest setTelephone(String telephone) {
        this.telephone = telephone;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateOwnerRequest.class != obj.getClass()) {
            return false;
        }
