...
public class AuditFacade {
    ...
    public void flushAfterTransaction() {
        ...
        auditFacade.flushAfterTransaction(correlationId, principalEmail);
    }

    @Async("multiThreadExecutor")
    public void flushAfterTransaction(String correlationId, Optional<String> principalEmail) {
        final long start = System.currentTimeMillis();
        AppThreadLocals.initialize(Optional.of(correlationId), principalEmail);
