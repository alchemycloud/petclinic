package co.drytools.backend.rest.dto.petapi;
...
public class RestUpdatePetRequest implements Serializable {
    ...
    private RestUpdatePetRequest() {}

    public RestUpdatePetRequest(OwnerId ownerId, String name, ZonedDateTime birthdate, PetType petType, Boolean vaccinated) {
        this();
    ...
    public final RestUpdatePetRequest setOwnerId(OwnerId ownerId) {
        this.ownerId = ownerId;
        return this;
    }
    ...
    public final RestUpdatePetRequest setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public final RestUpdatePetRequest setBirthdate(ZonedDateTime birthdate) {
        this.birthdate = birthdate;
        return this;
    }
    ...
    public final RestUpdatePetRequest setPetType(PetType petType) {
        this.petType = petType;
        return this;
    }
    ...
    public final RestUpdatePetRequest setVaccinated(Boolean vaccinated) {
        this.vaccinated = vaccinated;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (RestUpdatePetRequest.class != obj.getClass()) {
            return false;
        }
