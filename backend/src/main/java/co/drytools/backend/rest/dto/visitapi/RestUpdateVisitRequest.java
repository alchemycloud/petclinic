package co.drytools.backend.rest.dto.visitapi;
...
public class RestUpdateVisitRequest implements Serializable {
    ...
    private RestUpdateVisitRequest() {}

    public RestUpdateVisitRequest(
    ...
    public final RestUpdateVisitRequest setVetId(VetId vetId) {
        this.vetId = vetId;
        return this;
    }
    ...
    public final RestUpdateVisitRequest setPetId(PetId petId) {
        this.petId = petId;
        return this;
    }
    ...
    public final RestUpdateVisitRequest setVisitNumber(Integer visitNumber) {
        this.visitNumber = visitNumber;
        return this;
    }
    ...
    public final RestUpdateVisitRequest setTimestamp(ZonedDateTime timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public final RestUpdateVisitRequest setPetWeight(BigDecimal petWeight) {
        this.petWeight = petWeight;
        return this;
    }
    ...
    public final RestUpdateVisitRequest setDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public final RestUpdateVisitRequest setScheduled(Boolean scheduled) {
        this.scheduled = scheduled;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (RestUpdateVisitRequest.class != obj.getClass()) {
            return false;
        }
